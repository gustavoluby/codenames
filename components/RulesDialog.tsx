  ...
  return (
    <div className="overlay" onClick={onClose}>
      <div className="dialog" role="dialog" aria-modal="true" aria-labelledby="rules-title" onClick={(e) => e.stopPropagation()}>
        ...
        <ul>
          <li>Cada time tem um espião-mestre, que vê a cor de todas as cartas, e agentes, que não veem nada.</li>
          ...
          <li>Carta do próprio time: pode continuar. {NEUTRAL_LABEL} ou carta do adversário: a vez passa. {ASSASSIN_LABEL}: o time perde na hora.</li>
