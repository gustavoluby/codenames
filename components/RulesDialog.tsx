    ...
    <div className="overlay" onClick={onClose}>
      <div className="dialog" role="dialog" aria-modal="true" aria-labelledby="rules-title" onClick={(e) => e.stopPropagation()}>
        ...
        <ul>
          ...
          <li>Os agentes conversam, votam clicando nas cartas e revelam no ✓ do canto da carta quando decidirem. Podem fazer até número + 1 palpites (0 ou ∞ liberam palpites ilimitados), sempre pelo menos um.</li>
